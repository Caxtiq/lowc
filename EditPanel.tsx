      ...
      {editedItem.type === 'resource-item' && (
        <>
          ...
          <div className="mb-4">
            ...
            <Select name="type" value={editedItem.props.type || ''} onValueChange={(value) => handleChange({ target: { name: 'type', value } } as any)}>
              <SelectTrigger>
      ...
      {editedItem.type === 'personnel' && (
        <>
          ...
          <div className="mb-4">
            ...
            <Select name="specialty" value={editedItem.props.specialty || ''} onValueChange={(value) => handleChange({ target: { name: 'specialty', value } } as any)}>
              <SelectTrigger>
      ...
      {editedItem.type === 'emergency-event' && (
        <>
          ...
          <div className="mb-4">
            ...
            <Select name="severity" value={editedItem.props.severity || ''} onValueChange={(value) => handleChange({ target: { name: 'severity', value } } as any)}>
              <SelectTrigger>
        ...
        <>
          ...
          <div className="mb-4">
            ...
            <Input
              ...
              onChange={(e) => handleChange({ target: { name: 'route', value: { ...editedItem.props.route, start: e.target.value } } } as any)}
            />
          </div>
          <div className="mb-4">
            ...
            <Input
              ...
              onChange={(e) => handleChange({ target: { name: 'route', value: { ...editedItem.props.route, end: e.target.value } } } as any)}
            />
          </div>
        </>
      )}
      {editedItem.type === 'tracking-item' && (
        <>
          ...
          <div className="mb-4">
            ...
            <Select name="status" value={editedItem.props.status || ''} onValueChange={(value) => handleChange({ target: { name: 'status', value } } as any)}>
              <SelectTrigger>
      ...
      {editedItem.type === 'alert' && (
        <>
          ...
          <div className="mb-4">
            ...
            <Select name="urgency" value={editedItem.props.urgency || ''} onValueChange={(value) => handleChange({ target: { name: 'urgency', value } } as any)}>
              <SelectTrigger>
